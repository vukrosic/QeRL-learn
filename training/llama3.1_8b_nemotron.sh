...
export NODELIST=localhost
export TRAIN_NODES=localhost
export USE_VLLM=True
export VLLM_NODE=localhost
export VLLM_ALLOW_RUNTIME_LORA_UPDATING=True

MODEL_NAME="Llama-3.1-Nemotron-Nano-8B-v1-NVFP4A16"
MODEL_PATH="" # your NVFP4 model

max_prompt_length=1024
max_completion_length=8192
max_seq_length=10000

perdevice_train_batch_size=4
...
DATA_NAME="gsm8k"  # dapomath, gsm8k, codeforces
...
CUDA_VISIBLE_DEVICES=3 ACCELERATE_LOG_LEVEL=info \
